...
class BuilderBlocks extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['position', 'page_id', 'builder_id'], 'integer'],
            [['builder_table', 'title', 'description', 'class', 'js', 'style'], 'string', 'max' => 255],
    ...
    {
//
//        $block = BuilderBlocks::find()->where(['id' => $this->id])->one();
//        $id = $block->id;
//        $block1 = BuilderBlocks::find()->where(['id' => $this->id])->one();
//        $block1->position = $id;
//        $block1->update();
